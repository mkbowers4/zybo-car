...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = motor_steer_ctrl
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motor_steer_ctrl_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = videoprocessor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = videoprocessor_0
END
